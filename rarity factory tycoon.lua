...
local Bracket =
    loadstring(game:HttpGet("https://raw.githubusercontent.com/lucasr125/bracket-lib-v3.3/main/bracketv3.3.lua"))()
Bracket:Notification({Title = "Loaded.", Description = "Your tycoon is: " .. PlrTycoon.Name, Duration = 5})
...
do
    ...
    do
        local MainSection = MainTab:Section({Name = "Tycoon Functions", Side = "Left"})
        do
            local AutoGetOrbs =
                MainSection:Toggle(
                {
