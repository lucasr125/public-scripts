		...
		if ((game.Players.LocalPlayer.leaderstats.Glove.Value == "bus") and not game:GetService("BadgeService"):UserHasBadgeAsync(game.Players.LocalPlayer.UserId, 3335299217032061)) then
			...
			repeat
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("entered") then
					...
					repeat
						RandomPlayer = players[math.random(1, #players)];
					until (RandomPlayer ~= game.Players.LocalPlayer) and (RandomPlayer.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) and (RandomPlayer.Character.Head:FindFirstChild("UnoReverseCard") == nil) and RandomPlayer.Character:FindFirstChild("entered") 
					Target = RandomPlayer;
...
fireclickdetector(v)
	...
	Tab14:AddDropdown({Name="Equipped Glove Farm",Default="",Options={"Baller","Replica","Blink"},Callback=function(Value)
	...
	Tab14:AddButton({Name="Kill Player Random",Callback=function()
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Home Run") then
			...
			repeat
				RandomPlayer = players[math.random(1, #players)];
			until (RandomPlayer ~= game.Players.LocalPlayer) and (RandomPlayer.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) and (RandomPlayer.Character.Head:FindFirstChild("UnoReverseCard") == nil) 
			Target = RandomPlayer;
	...
	Tab7:AddButton({Name="View Testing Server",Callback=function()
		local teleportFunc = queueonteleport or queue_on_teleport or (syn and syn.queue_on_teleport);
		if teleportFunc then
			teleportFunc([[
        if not game:IsLoaded() then
...
game.CoreGui.RobloxLoadingGUI:Destroy()
	...
	Tab7:AddDropdown({Name="Teleport",Default="",Options={"Arena","Lobby","Hunter Room","Brazil","Island Slapple","Plate","Tournament","Cannon Island","Equip Glovel","Keypad","Moai Island","Default Arena","Island 1","Island 2","Island 3"},Callback=function(Value)
		if (Value == "Arena") then
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.workspace.Origo.CFrame * CFrame.new(0, -5, 0);
	...
	Tab7:AddButton({Name="Auto Enter Map Null",Callback=function()
	...
	NotifyGoldenSlapple = Tab7:AddToggle({Name="Auto Notification Golden Slapple",Default=false,Callback=function(Value)
		_G.NotifyGoldenSlapple = Value;
		while _G.NotifyGoldenSlapple do
			if (game.Workspace.Arena.island5.Slapples.GoldenSlapple.Glove:FindFirstChildWhichIsA("TouchTransmitter") == nil) then
				repeat
					task.wait();
				until game.Workspace.Arena.island5.Slapples.GoldenSlapple.Glove:FindFirstChildWhichIsA("TouchTransmitter") ~= nil 
	...
	Tab7:AddTextbox({Name="Help Player Join Ice",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab7:AddButton({Name="Player Help Join Ice",Callback=function()
		...
		while _G.AutoFarmSlap do
			pcall(function()
				for i, v in next, game.Players:GetChildren() do
					if ((v ~= game.Players.LocalPlayer) and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character) then
						if (game.Players.LocalPlayer.Character:FindFirstChild("entered") and v.Character:FindFirstChild("entered") and v.Character:FindFirstChild("HumanoidRootPart") and (v.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) and (v.Character.HumanoidRootPart.BrickColor ~= BrickColor.new("New Yeller")) and (v.Character.Ragdolled.Value == false)) then
	...
	Tab7:AddToggle({Name="Auto Spam Ability",Default=false,Callback=function(Value)
		...
		while On and (game.Players.LocalPlayer.leaderstats.Glove.Value == "Jet") do
			...
			repeat
				RandomPlayer = players[math.random(1, #players)];
			until (RandomPlayer ~= game.Players.LocalPlayer) and RandomPlayer.Character:FindFirstChild("entered") and (RandomPlayer.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) 
			Target = RandomPlayer;
		...
		while On and (game.Players.LocalPlayer.leaderstats.Glove.Value == "Ferryman") do
			...
			repeat
				randomPlayer = players[math.random(1, #players)];
			until (randomPlayer ~= game.Players.LocalPlayer) and randomPlayer.Character:FindFirstChild("entered") and (randomPlayer.Character:FindFirstChild("ded") == nil) and (randomPlayer.Character:FindFirstChild("InLabyrinth") == nil) and (randomPlayer.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) 
			Target = randomPlayer;
	...
	Tab7:AddSlider({Name="Time Give Kill Reaper",Min=1,Max=20,Default=20,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Kill Reaper",Callback=function(Value)
	...
	Tab7:AddToggle({Name="Auto Give Player Kill Reaper",Default=false,Callback=function(Value)
	...
	Tab7:AddTextbox({Name="Glove & Glove Tournament",Default="Use Glove",TextDisappear=false,Callback=function(Value)
		_G.EquipGlove = Value;
	end});
	Tab7:AddButton({Name="Equip Glove",Callback=function()
		if (game.Players.LocalPlayer.Character:FindFirstChild("entered") == nil) then
	...
	Tab7:AddButton({Name="Equip Glove Tournament",Callback=function()
		if (game.Players.LocalPlayer.Character:FindFirstChild("entered") == nil) then
			fireclickdetector(game.Workspace.Lobby[_G.EquipGlove].ClickDetector);
			wait(0.5);
			repeat
	...
	Tab7:AddToggle({Name="Anti Cooldown",Default=false,Callback=function(Value)
		AntiCooldown = Value;
		game:GetService("RunService").RenderStepped:Connect(function()
	...
	Tab7:AddSlider({Name="Slap Aura cooldown",Min=0,Max=1,Default=0.1,Color=Color3.fromRGB(255, 255, 255),Increment=0.01,ValueName="Cooldown",Callback=function(Value)
	...
	Tab7:AddToggle({Name="Slap Aura",Default=false,Callback=function(Value)
		...
		while SlapAura and (SlapAuraFriend == "Fight") do
			pcall(function()
				for i, v in next, game.Players:GetChildren() do
					if ((v ~= game.Players.LocalPlayer) and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character) then
						if (v.Character:FindFirstChild("entered") and v.Character:FindFirstChild("HumanoidRootPart") and (v.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) and (v.Character.HumanoidRootPart.BrickColor ~= BrickColor.new("New Yeller")) and (v.Character.Ragdolled.Value == false)) then
							if ((v.Character.Head:FindFirstChild("UnoReverseCard") == nil) or (game.Players.LocalPlayer.leaderstats.Glove.Value == "Error")) then
								Magnitude = (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Character.HumanoidRootPart.Position).Magnitude;
								if ((_G.ReachSlapArua >= Magnitude) and (slapAuraDebounce == false)) then
									slapAuraDebounce = true;
									wait(_G.SlapAuraCooldown);
		...
		while SlapAura and (SlapAuraFriend == "Not Fight") do
			pcall(function()
				for i, v in next, game.Players:GetChildren() do
					if ((v ~= game.Players.LocalPlayer) and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character) then
						if (v.Character:FindFirstChild("entered") and v.Character:FindFirstChild("HumanoidRootPart") and (v.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) and (v.Character.HumanoidRootPart.BrickColor ~= BrickColor.new("New Yeller")) and not game.Players.LocalPlayer:IsFriendsWith(v.UserId) and (v.Character.Ragdolled.Value == false)) then
							if ((v.Character.Head:FindFirstChild("UnoReverseCard") == nil) or (game.Players.LocalPlayer.leaderstats.Glove.Value == "Error")) then
								Magnitude = (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Character.HumanoidRootPart.Position).Magnitude;
		...
		elseif (ShukuchiFriend == "Not Fight") then
			if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Shukuchi") then
				while _G.AutoShukuchi and (game.Players.LocalPlayer.leaderstats.Glove.Value == "Shukuchi") and (ShukuchiFriend == "Not Fight") do
					for i, v in pairs(game.Players:GetPlayers()) do
						if ((v ~= game.Players.LocalPlayer) and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character) then
							if (v.Character:FindFirstChild("entered") and v.Character:FindFirstChild("HumanoidRootPart") and (v.Character:FindFirstChild("rock") == nil) and (v.Character:FindFirstChild("stevebody") == nil) and (v.Character.HumanoidRootPart.BrickColor ~= BrickColor.new("New Yeller")) and (v.Character.Head:FindFirstChild("RedEye") == nil)) then
								if (v.Character.Head:FindFirstChild("UnoReverseCard") == nil) then
									Magnitude = (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Character.HumanoidRootPart.Position).Magnitude;
									if (_G.ReachShukuchi >= Magnitude) then
										game:GetService("ReplicatedStorage").SM:FireServer(v);
	...
	Tab7:AddToggle({Name="ESP Gift | Jet | Phase",Default=false,Callback=function(Value)
		_G.AllESP = Value;
	...
	Tab7:AddToggle({Name="Esp Exit Run",Default=false,Callback=function(Value)
		_G.ExitESP = Value;
	...
	Tab7:AddDropdown({Name="Tycoon Auto",Default="All",Options={"Other","All","Your"},Callback=function(Value)
		_G.TycoonAuto = Value;
	end});
	...
	AntiPyschoVoid = Tab12:AddToggle({Name="Anti Void Obby Pyscho",Default=false,Callback=function(Value)
	...
	Tab12:AddToggle({Name="Anti Void Obby Retro",Default=false,Callback=function(Value)
	...
	Tab12:AddToggle({Name="Anti Water Kraken",Default=false,Callback=function(Value)
	...
	AntiPingPong = Tab2:AddToggle({Name="Anti Ping Pong",Default=false,Callback=function(Value)
	...
	AntiDruid = Tab2:AddToggle({Name="Anti Druid",Default=false,Callback=function(Value)
		_G.AntiDruid = Value;
	...
	Tab2:AddDropdown({Name="Ragdoll Character",Default="Reset",Options={"Reset","Not Reset"},Callback=function(Value)
	...
	Tab15:AddButton({Name="Copy Subscribe DonjoSx [ DonjoScript ]",Callback=function()
		setclipboard("www.youtube.com/@DonjoScript");
	end});
	Tab15:AddButton({Name="[ Destroy GUI ] | [ Destroy Toggle Gui ]",Callback=function()
		OrionLib:Destroy();
...
elseif (game.PlaceId == 15507333474) then
	...
	Tab2:AddButton({Name="[ Destroy GUI ] [ All Toggle Gui ]",Callback=function()
		OrionLib:Destroy();
		if (game.Players.LocalPlayer.PlayerGui:FindFirstChild("ToggleUi") ~= nil) then
			for i, v in pairs(game.Players.LocalPlayer.PlayerGui:GetChildren()) do
				if (v.Name == "ToggleUi") then
